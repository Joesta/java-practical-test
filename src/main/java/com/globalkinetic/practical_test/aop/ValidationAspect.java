...
public class ValidationAspect {
    ...
    @Before(value = "execution(* com.globalkinetic.practical_test.services.jwt.JwtBlacklistService.blacklist(..)) && args(userId, authentication)", argNames = "userId,authentication")
    public void checkAuthorization(Long userId, Authentication authentication) {
